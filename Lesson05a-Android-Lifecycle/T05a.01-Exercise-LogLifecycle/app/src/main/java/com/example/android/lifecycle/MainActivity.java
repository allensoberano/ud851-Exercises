...
public class MainActivity extends AppCompatActivity {
    ...
    //When activity is starts to show to user
    @Override
    ...
    // When activity comes to foreground. Top of activity stack
    @Override
    ...
    //When system is about to start resuming a previous activity.
    @Override
    ...
    //When activity becomes hidden and no longer visible to the user.
    @Override
    ...
    // after activity has been stopped, prior to being started again.
    @Override
